...
• `{i}gdul <reply/file name>`
    Balas ke file untuk mengunggah di Google Drive.
    Tambahkan nama file untuk diunggah di Google Drive.

• `{i}gdown <file id/link> | <filename>`
    Unduh dari tautan Gdrive atau id file.

• `{i}gdsearch <file name>`
    Cari nama file di Google Drive dan dapatkan tautan.

• `{i}gdlist`
    Daftar semua file GDrive.

• `{i}gdfolder`
    Tautkan ke Folder Google Drive Anda.
    Jika ditambahkan maka semua file akan diunggah di folder ini.
"""
