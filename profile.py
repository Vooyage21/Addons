...
@dante_cmd(pattern="[Ss]etbio( (.*)|$)", fullsudo=False)
async def _(dante):
    ok = await dante.eor("...")
...
@dante_cmd(pattern="[Ss]etname ?((.|//)*)", fullsudo=False)
async def _(dante):
    ok = await dante.eor("...")
...
@dante_cmd(pattern="[sS]etfp$", fullsudo=False)
async def _(dante):
...
@dante_cmd(pattern="[dD]elfp( (.*)|$)", fullsudo=False)
